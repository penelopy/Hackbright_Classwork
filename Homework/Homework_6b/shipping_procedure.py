...
def main():
    ...
    for line in f:
        ...
        #    <melon name>: <quantity>
        (produce_type, quantity) = line.rstrip().split(':')
        quantity = int(quantity)
        
        print "\n-----"
        print "Fullfilling order of %d %s" % (quantity, produce_type)
        print "-----\n"
        ...
        print "------"
        print "Robots Picked %d %s for order of %d" % (count, produce_type, quantity)
