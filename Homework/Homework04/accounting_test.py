...
def check_for_underpayment(name, num_melons_bought, amt_paid):
    melon_cost = 1.00
    if amt_paid == num_melons_bought * melon_cost: 
        pass
    else: 
        amt_due = num_melons_bought * melon_cost - amt_paid
        print "%s has a balance of %d" % (name, amt_due) 
